...
def training(sentences):
    ...
    for t1 in tag_list:
        ...
        for word in emit_prob[t1]:
            emit_prob[t1][word] = (emit_prob[t1][word] + emit_epsilon) / (emit_prob_nT + emit_epsilon * (emit_prob_VT + 1))
        emit_prob[t1][None] = (emit_epsilon) / (emit_prob_nT + emit_epsilon * (emit_prob_VT + 1))
